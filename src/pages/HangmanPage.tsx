...
function HangmanPage() {
  const { playing, win, startGame, word, guesses, setWin, setGuesses } = useHangManStore();
  ...
  return (
    <div className={"container-fluid text-center bg-body-tertiary pb-3"}>
      ...
      <button onClick={() => startGame(getWord())} className={"btn btn-primary d-block my-2 px-4 m-auto"}>
        {playing ? "Reset" : "Play"}
      </button>
